 ...
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * | Tab  |   Q  |   W  |   E  |   R  |   T  |                    |   Z  |   U  |   I  |   O  |   P  |BackSP|
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 ...
 */
 ...
 [_QWERTY] = LAYOUT( \
  ...
  KC_LSFT,  KC_Y,   KC_X,    KC_C,    KC_V,    KC_B, KC_LBRC,  KC_RBRC,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  KC_RSFT, \
                        KC_LALT, KC_LGUI, MO(_LOWER), KC_SPC, KC_ENT, MO(_RAISE), _______, KC_RGUI \
),
/* LOWER
 * ,-----------------------------------------.                    ,-----------------------------------------.
...
[_LOWER] = LAYOUT( \
  ...
  _______, _______, _______, _______, _______, _______,                    KC_EQL,  KC_PLUS, KC_MINS,   KC_ASTR, KC_SLSH, KC_BSPC, \
